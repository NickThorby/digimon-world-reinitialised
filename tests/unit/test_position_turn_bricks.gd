extends GutTest
## Unit tests for Session 5: positionControl, turnEconomy, and chargeRequirement
## bricks. Tests cover force switching, voluntary switch-out, baton pass,
## multi-hit, recharge, delayed effects, charging, semi-invulnerability, and
## multi-turn lock mechanics.
