...
@onready var _side_selector: OptionButton = %SideSelector
@onready var _team_list: VBoxContainer = %TeamList
@onready var _add_digimon_button: Button = %AddDigimonButton
@onready var _controller_option: OptionButton = %ControllerOption
@onready var _wild_toggle: CheckBox = %WildToggle
@onready var _xp_toggle: CheckBox = %XPToggle
@onready var _launch_button: Button = %LaunchButton
@onready var _back_button: Button = %BackButton
@onready var _save_team_button: Button = %SaveTeamButton
@onready var _load_team_button: Button = %LoadTeamButton
